...
- [discord-py-slash-commands/discord-py-interactions](https://github.com/discord-py-slash-commands/discord-py-interactions) - A simple discord slash command handler for discord.py.
